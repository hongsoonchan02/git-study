...
public class Ex23_Main {
	...
	public static void main(String[] args) {
		...
		// 개발자 남자는 마트를 다녀온 뒤 우유를 6개 건내며 말했다. "아보카도 있었어"
		// 조건에 맞춰 기능을 구현하세요.
		...
		Ex23_2_AvocadoCondition ac = new Ex23_2_AvocadoCondition();
		...
		Ex23_2_NoAvocado na = new Ex23_2_NoAvocado();
		market.goSuperMarket(na);
		System.out.println("구입한 우유 개수 : " + market.getMilkCount()); 
